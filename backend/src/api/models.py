...
class DamageReport(models.Model):
    ...
    photo = models.ForeignKey(ConditionPhoto, on_delete=models.CASCADE, related_name='damage_reports')
    ...
    def __str__(self):
        return f"Damage report for {self.photo.equipment.name} on {self.reported_at.strftime('%Y-%m-%d')}"