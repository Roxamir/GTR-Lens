...
# This block configures storage based on the DEBUG setting

# Start with a base STORAGES config for static files
STORAGES = {
    "staticfiles": {
...
if DEBUG:
    ...
    # Set the 'default' storage to local
    STORAGES["default"] = {
